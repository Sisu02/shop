          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-12 col-12 bm-4 mb-xl-0">
                <h3 class="text-muted text-center mb-3">Add Plan</h3>
  ...
  @endif
                <form action="/insertplan" method="post" enctype="multipart/form-data">
                  @csrf
    <div class="form-group">
      <label for="cname">Plan name:</label>
      <input type="text" name="name" class="form-control" value="{{old('cname')}}" id="cname">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="cname">Plan cost:</label>
      <input type="number" name="pcost" class="form-control" value="{{old('pcost')}}" id="cname">
    </div>
    <div class="form-group">
    ...
    <div id="famount" class="hide form-group">
      ...
      <input type="number" name="famount" class="form-control" value="{{old('famount')}}" id="amount">
    </div>
    <div id="pamount" class="hide form-group">
    <label for="amount">Amount:</label>
    <input type="number" name="pamount" class="form-control" value="{{old('pamount')}}" id="amount" min="0" max="100">
    </div>
    <div class="form-group">
