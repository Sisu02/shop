          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-12 col-12 bm-4 mb-xl-0">
                <h3 class="text-muted text-center mb-3">Edit Coupon</h3>
  ...
  @endif
                <form action="/updatecoupon/{{$coupon->id}}" method="post" enctype="multipart/form-data">
                  @csrf
    <div class="form-group">
      <label for="cname">Coupon name:</label>
      <input type="text" name="cname" class="form-control" value="{{$coupon->name}}" id="cname">
    </div>
    <div class="form-group">
    ...
    <div id="famount" class="hide form-group">
      ...
      <input type="text" name="famount" class="form-control" value=" @if($coupon->type=="flat") {{$coupon->amount}} @endif" id="amount">
    </div>
    <div id="pamount" class="hide form-group">
    <label for="amount">Amount:</label>
    <input type="text" name="pamount" class="form-control" value="@if($coupon->type=="percentage"){{$coupon->amount}}   @endif" id="amount" min="0" max="100">
    </div>
    <div class="form-group">
      <label for="sdate">Start Date:</label>
      <input type="date" name="sdate" class="form-control" value="{{ \Carbon\Carbon::parse($coupon->sdate)->format('Y-m-d') }}" id="sdate">
    </div>
    <div class="form-group">
      <label for="edate">End Date:</label>
      <input type="date" name="edate" class="form-control" value="{{ \Carbon\Carbon::parse($coupon->sdate)->format('Y-m-d') }}" id="edate">
    </div>
